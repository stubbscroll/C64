...
; a000-cee0: generated unrolled scroll routine
; 0800-09ff: code
; 0a00-59ff: text

textlength    = 100    ; number of lines with text

bordercol     = 0
backgroundcol = 0
maxspeed      = 32 ; pixels per frame

showscreen    = $0400
showcharset   = $14   ; d018 value. 14=upper case, 16=lower case

scroll = $a000      ; location of scroll routine
...
-	cmp $d012
	...
	; and send it as x to the ugly loop
	lda screenat+1
	sta temp1
	lda screenat+0
	lsr temp1
...
generate
	...
	stx temp3+0
	sty temp3+1
	ldx #0           ; set pointer to colour mem
	ldy #$d8
	stx temp4+0
	sty temp4+1
